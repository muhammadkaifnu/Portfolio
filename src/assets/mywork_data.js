...
const mywork_data = [
  ...
  {
    w_no: 3,
    w_name: 'Helpix - AI-Powered Emergency Response System',
    w_img: helpix3,
    headline: 'Smart emergency detection and response platform with YOLOv8.',
    description:
      'An intelligent emergency response platform that uses computer vision and machine learning to detect accidents and emergencies in real-time. Integrates YOLOv8 for object detection and custom accident detection models via FastAPI. Features include automated emergency alerts, real-time video analysis, incident reporting, and admin dashboard for monitoring. Built with MERN stack for the web application and FastAPI to connect Python ML models for advanced detection capabilities.',
    repo: 'https://github.com/muhammadkaifnu/helpix',
    live: 'https://helpix-support.vercel.app',
    techStack: ['MongoDB', 'Express', 'React', 'Node.js', 'FastAPI', 'Python', 'YOLOv8'],
